...
--
-- Servidor: localhost
-- Tiempo de generación: 28-11-2023 a las 06:25:18
...
(17, 19, 'img/imguser/Yuki_and_Kyon_by_MMMM9_on_DeviantArtKNCLL.jpg');
...
(19, 'fer', 'fer@fer', 'pbkdf2:sha256:600000$s12lKGr4crlwxbUQ$6b23003d94cb912d83c9041cd1a82de502faccba6e3609d878647e304964e83f', 'C');
...
--
ALTER TABLE `gpersonal`
  MODIFY `NumIMG` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT de la tabla `img_saved`
--
ALTER TABLE `img_saved`
  MODIFY `idimgarchive` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
